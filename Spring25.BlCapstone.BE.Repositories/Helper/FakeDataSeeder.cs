    ...
    public static class FakeDataSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Yield>().HasData(
                ...
                new Yield { Id = 2, YieldName = "Nông trại B", AreaUnit = "m2", Area = 300, Description = "Đất chua nhẹ", Type = "Thâm canh", Status = "Maintenance" },
                new Yield { Id = 3, YieldName = "Ruộng C", AreaUnit = "m2", Area = 800, Description = "Đất phèn nhẹ", Type = "Luân canh", Status = "Available" },
            ...
            modelBuilder.Entity<Plan>().HasData(
                new Plan { Id = 1, PlantId = 3, YieldId = 11, ExpertId = 1, PlanName = "Kế hoạch Xà lách xoăn - Mùa Phụ", Description = "Kế hoạch trồng xà lách xoăn vào mùa phụ - khí hậu không ổn định, chất lượng có thể không đảm bảo", StartDate = new DateTime(2025, 4, 5), EndDate = new DateTime(2025, 6, 15), Status = "Ongoing", EstimatedProduct = 200, SeedQuantity = 185, CreatedAt = DateTime.Now.AddMonths(-5), CreatedBy = "Hoàng Quỳnh J", IsApproved = true },
                new Plan { Id = 2, PlantId = 2, YieldId = 1, ExpertId = 2, PlanName = "Trồng dưa lưới", Description = "Kế hoạch trồng dưa lưới trong nhà kính", StartDate = new DateTime(2025, 2, 1), EndDate = new DateTime(2025, 6, 1), Status = "Ongoing", EstimatedProduct = 300, SeedQuantity = 285, CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = true },
                new Plan { Id = 3, PlantId = 9, YieldId = 15, ExpertId = 3, PlanName = "Trồng dưa leo", Description = "Kế hoạch trồng dưa leo sạch", StartDate = new DateTime(2025, 3, 15), EndDate = new DateTime(2025, 6, 30), Status = "Ongoing", EstimatedProduct = 400, SeedQuantity = 385, CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = true },
                new Plan { Id = 4, PlantId = 4, YieldId = 17, ExpertId = 1, PlanName = "Trồng rau muống", Description = "Kế hoạch trồng rau muống ngắn ngày", StartDate = new DateTime(2025, 4, 5), EndDate = new DateTime(2025, 5, 5), CompleteDate = new DateTime(2025, 5, 10), Status = "Cancel", EstimatedProduct = 200, SeedQuantity = 185, CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = false },
                new Plan { Id = 5, PlantId = 5, YieldId = 5, ExpertId = 2, PlanName = "Trồng cà rốt", Description = "Kế hoạch trồng cà rốt hữu cơ", StartDate = new DateTime(2025, 5, 1), EndDate = new DateTime(2025, 9, 1), Status = "Pending", EstimatedProduct = 350, SeedQuantity = 300, CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = false },
                new Plan { Id = 6, PlantId = 6, YieldId = 10, ExpertId = 3, PlanName = "Trồng hành lá", Description = "Kế hoạch trồng hành lá sạch", StartDate = new DateTime(2025, 6, 10), EndDate = new DateTime(2025, 9, 30), Status = "Pending", EstimatedProduct = 250, SeedQuantity = 205, CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = false },
                new Plan { Id = 7, PlantId = 10, YieldId = 16, ExpertId = 2, PlanName = "Mùa vụ trồng củ cải trắng", Description = "Bản kế hoạch chi tiết trồng củ cải trắng ngắn hạn trong vòng 30 ngày", StartDate = DateTime.Now.AddMonths(5), EndDate = DateTime.Now.AddMonths(10), Status = "Draft", EstimatedProduct = 500, SeedQuantity = 485, CreatedAt = DateTime.Now.AddDays(-10), CreatedBy = "Admin", IsApproved = false },
                new Plan { Id = 8, PlantId = 10, YieldId = 11, ExpertId = 1, PlanName = "Mùa vụ trồng cà chua", Description = "Bản kế hoạch chi tiết trồng cà chua trong vòng 60 ngày", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(60), Status = "Pending", EstimatedProduct = 500, SeedQuantity = 485, CreatedAt = DateTime.Now.AddDays(-10), CreatedBy = "Lê Quang C", IsApproved = false },
                new Plan { Id = 9, PlantId = 1, YieldId = 1, ExpertId = 3, PlanName = "Kế hoạch Rau muống - Mùa Hạ", Description = "Kế hoạch trồng rau muống mùa hạ cho ra năng suất nông sản mạnh, có 1 số tác nhân giúp cây có thể săn chắc mà không bị héo ảnh hưởng bới mùa nắng to.", StartDate = new DateTime(2025, 5, 3), EndDate = new DateTime(2025, 7, 6), CompleteDate = null, Status = "Ongoing", EstimatedProduct = 200, SeedQuantity = 185, CreatedAt = new DateTime(2025, 4, 20), CreatedBy = "Hoàng Quỳnh J", IsApproved = true }
            );
            ...
            modelBuilder.Entity<CaringTask>().HasData(
                new CaringTask { Id = 1, PlanId = 1, ProblemId = 1, Description = "Tưới nước đều đặn vào sáng sớm và chiều tối để giữ ẩm cho cây cà chua, tránh tưới quá nhiều gây ngập úng.", TaskName = "Tưới nước cho cà chua", TaskType = "Watering", StartDate = new DateTime(2025, 1, 12,7,30, 0), EndDate = new DateTime(2025, 1, 12,9, 30, 0), CompleteDate = new DateTime(2025, 1, 12, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "thangbinhbeo" },
                new CaringTask { Id = 2, PlanId = 2, ProblemId = 2, Description = "Sử dụng phân hữu cơ để cung cấp dưỡng chất cho cây cà chua, bón vào gốc cây tránh tiếp xúc trực tiếp với lá.", TaskName = "Bón phân hữu cơ cho cà chua", TaskType = "Fertilizing", StartDate = new DateTime(2025, 2, 18, 7, 30, 0), EndDate = new DateTime(2025, 2, 20, 10, 30, 0), CompleteDate = new DateTime(2025, 2, 20, 10, 0, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "thangbinhbeo" },
                new CaringTask { Id = 3, PlanId = 2, Description = "Quan sát lá, thân và quả dưa lưới để phát hiện dấu hiệu sâu bệnh, sử dụng biện pháp phòng trừ phù hợp.", TaskName = "Kiểm tra sâu bệnh trên dưa lưới", TaskType = "Weeding", StartDate = new DateTime(2025, 2, 10, 8, 30, 0), EndDate = new DateTime(2025, 2, 12, 10, 30, 0), CompleteDate = new DateTime(2025, 2,12, 10, 20, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "thangbinhbeo" },
                new CaringTask { Id = 4, PlanId = 2, ProblemId = 4, Description = "Thiết lập hệ thống tưới nhỏ giọt giúp cây nhận đủ nước mà không gây lãng phí.", TaskName = "Lắp hệ thống tưới tự động", TaskType = "Setup", StartDate = new DateTime(2025, 2, 15, 7, 30, 0), EndDate = new DateTime(2025, 2, 18,17,30,0), CompleteDate = new DateTime(2025, 2, 17, 18, 30, 0), Status = "Ongoing", CreatedAt = DateTime.Now, CreatedBy = "thangbinhbeo" },
                ...
                new CaringTask { Id = 13, PlanId = 4, ProblemId = 3, Description = "Loại bỏ cỏ dại thủ công để tránh ảnh hưởng đến xà lách non.", TaskName = "Nhổ cỏ dại trong vườn xà lách", TaskType = "Weeding", StartDate = new DateTime(2025, 9, 15), EndDate = new DateTime(2025, 9, 17), CompleteDate = new DateTime(2025, 9, 20), Status = "Cancel", CreatedAt = DateTime.Now, CreatedBy = "thangbinhbeo" },
                ...
                new CaringTask { Id = 16, PlanId = 8, Description = "Ngâm hạt trong nước ấm (40–50°C) khoảng 3–4 giờ để kích thích nảy mầm. Sau đó, ủ hạt trong khăn ẩm hoặc giấy ướt đặt nơi ấm áp, tránh ánh sáng trực tiếp, đến khi hạt nứt nanh (khoảng 1–2 ngày) .", TaskName = "Ươm hạt giống cà chua", TaskType = "Setup", StartDate = new DateTime(2025, 5, 1, 17, 30, 0), EndDate = new DateTime(2025, 5, 3, 17, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 17, PlanId = 8, Description = "Gieo 2–3 hạt vào mỗi bầu đất, sâu khoảng 0,5 cm. ", TaskName = "Gieo hạt vào khay ươm", TaskType = "Setup", StartDate = new DateTime(2025, 5, 4, 7, 30, 0), EndDate = new DateTime(2025, 5, 4, 14, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 18, PlanId = 8, Description = "Giữ ẩm đất bằng cách phun nước nhẹ nhàng ", TaskName = "Đảm bảo cây con nảy mầm và phát triển khỏe mạnh 1", TaskType = "Setup", StartDate = new DateTime(2025, 5, 5, 7, 30, 0), EndDate = new DateTime(2025, 5, 5, 9, 30, 0),  Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 19, PlanId = 8, Description = "Giữ ẩm đất bằng cách phun nước nhẹ nhàng ", TaskName = "Đảm bảo cây con nảy mầm và phát triển khỏe mạnh 2", TaskType = "Setup", StartDate = new DateTime(2025, 5, 6, 7, 30, 0), EndDate = new DateTime(2025, 5, 6, 9, 30, 0),  Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 20, PlanId = 8, Description = "Giữ ẩm đất bằng cách phun nước nhẹ nhàng ", TaskName = "Đảm bảo cây con nảy mầm và phát triển khỏe mạnh 3", TaskType = "Setup", StartDate = new DateTime(2025, 5, 7, 7, 30, 0), EndDate = new DateTime(2025, 5, 7, 9, 30, 0),  Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 21, PlanId = 8, Description = "Giữ ẩm đất bằng cách phun nước nhẹ nhàng ", TaskName = "Đảm bảo cây con nảy mầm và phát triển khỏe mạnh 4", TaskType = "Setup", StartDate = new DateTime(2025, 5, 8, 7, 30, 0), EndDate = new DateTime(2025, 5, 8, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 22, PlanId = 8, Description = "Giữ ẩm đất bằng cách phun nước nhẹ nhàng ", TaskName = "Đảm bảo cây con nảy mầm và phát triển khỏe mạnh 5", TaskType = "Setup", StartDate = new DateTime(2025, 5, 9, 7, 30, 0), EndDate = new DateTime(2025, 5, 9, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 23, PlanId = 8, Description = "Phân luống giữ khoảng cách giữa các cây từ 40–60 cm, hàng cách hàng khoảng 80 cm, trộn đất với phân hữu cơ, đất thịt và giá thể theo tỷ lệ 3:3:4 ", TaskName = "Chuẩn bị đất trồng cây con", TaskType = "Setup", StartDate = new DateTime(2025, 5, 10, 7, 30, 0), EndDate = new DateTime(2025, 5, 10, 17, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 24, PlanId = 8, Description = "Trồng cây con đặt cây thẳng đứng, lấp đất chặt quanh gốc, tưới nước ngay sau khi trồng. ", TaskName = "Trồng cây con", TaskType = "Setup", StartDate = new DateTime(2025, 5, 10, 16, 30, 0), EndDate = new DateTime(2025, 5, 10, 19, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 25, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, tưới nhẹ gốc và tránh làm tổn thương thân non", TaskName = "Tưới nước cho cây cà chua  1", TaskType = "Watering", StartDate = new DateTime(2025, 5, 11, 7, 30, 0), EndDate = new DateTime(2025, 5, 11, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 26, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, tránh tưới lên lá để hạn chế bệnh nấm. ", TaskName = "Tưới nước cho cây cà chua  2", TaskType = "Watering", StartDate = new DateTime(2025, 5, 12, 7, 30, 0), EndDate = new DateTime(2025, 5, 12, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 27, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, tránh tưới lên lá để hạn chế bệnh nấm.", TaskName = "Tưới nước cho cây cà chua  3", TaskType = "Watering", StartDate = new DateTime(2025, 5, 13, 7, 30, 0), EndDate = new DateTime(2025, 5, 13, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 28, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, chuẩn bị giàn đỡ giúp đỡ cây", TaskName = "Tưới nước cho cây cà chua  4", TaskType = "Watering", StartDate = new DateTime(2025, 5, 14, 7, 30, 0), EndDate = new DateTime(2025, 5, 14, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 29, PlanId = 8, Description = "Phun thuốc phòng ngừa sâu bệnh ăn thân, phun thuốc vào sáng sớm", TaskName = "Phun định kỳ 1", TaskType = "Pesticide", StartDate = new DateTime(2025, 5, 15, 7, 30, 0), EndDate = new DateTime(2025, 5, 15, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 30, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, tránh tưới lên lá để hạn chế bệnh nấm.", TaskName = "Tưới nước cho cây cà chua  5", TaskType = "Watering", StartDate = new DateTime(2025, 5, 16, 7, 30, 0), EndDate = new DateTime(2025, 5, 16, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 31, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, quấn cây vào giàn đỡ giúp cây phát triển cành theo hướng giàn đỡ", TaskName = "Tưới nước cho cây cà chua 6", TaskType = "Watering", StartDate = new DateTime(2025, 5, 17, 7, 30, 0), EndDate = new DateTime(2025, 5, 17, 10, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 32, PlanId = 8, Description = "Bón phân thúc: Bón rải quanh gốc, sau đó tưới nước để phân thấm vào đất. ", TaskName = "Bón thúc lần 1", TaskType = "Fertilizing", StartDate = new DateTime(2025, 5, 18, 7, 30, 0), EndDate = new DateTime(2025, 5, 18, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 33, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, tránh tưới lên lá để hạn chế bệnh nấm.", TaskName = "Tưới nước cho cây cà chua  7", TaskType = "Watering", StartDate = new DateTime(2025, 5, 19, 7, 30, 0), EndDate = new DateTime(2025, 5, 19, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 34, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: tưới ướt đất, không để bị úng", TaskName = "Tưới nước cho cây cà chua 8", TaskType = "Watering", StartDate = new DateTime(2025, 5, 20, 7, 30, 0), EndDate = new DateTime(2025, 5, 20, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 35, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: kiểm tra lá cây có thể xuất hiện sâu bệnh", TaskName = "Tưới nước cho cây cà chua  9", TaskType = "Watering", StartDate = new DateTime(2025, 5, 21, 7, 30, 0), EndDate = new DateTime(2025, 5, 21, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 36, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây trong giai đoạn phát triển mạnh mẽ dễ xuất hiện sâu bệnh", TaskName = "Tưới nước cho cây cà chua  10", TaskType = "Watering", StartDate = new DateTime(2025, 5, 22, 7, 30, 0), EndDate = new DateTime(2025, 5, 22, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 37, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: kiểm tra ngọn cây có bị gãy hoặc đứt ngang do sâu bệnh", TaskName = "Tưới nước cho cây cà chua  11", TaskType = "Watering", StartDate = new DateTime(2025, 5, 23, 7, 30, 0), EndDate = new DateTime(2025, 5, 23, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 38, PlanId = 8, Description = "Phun thuốc phòng ngừa sâu bệnh ăn lá, phun thuốc vào sáng sớm", TaskName = "Phun định kỳ 2", TaskType = "Pesticide", StartDate = new DateTime(2025, 5, 24, 7, 30, 0), EndDate = new DateTime(2025, 5, 24, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 39, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây trong giai đoạn phát triển mạnh mẽ dễ xuất hiện sâu bệnh", TaskName = "Tưới nước cho cây cà chua  12", TaskType = "Watering", StartDate = new DateTime(2025, 5, 25, 7, 30, 0), EndDate = new DateTime(2025, 5, 25, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 40, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây bắt đầu xuất hiện hoa", TaskName = "Tưới nước cho cây cà chua 13", TaskType = "Watering", StartDate = new DateTime(2025, 5, 26, 7, 30, 0), EndDate = new DateTime(2025, 5, 26, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 41, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây bắt đầu xuất hiện hoa", TaskName = "Tưới nước cho cây cà chua 14", TaskType = "Watering", StartDate = new DateTime(2025, 5, 27, 7, 30, 0), EndDate = new DateTime(2025, 5, 27, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 42, PlanId = 8, Description = "Bón phân thúc: Bón rải quanh gốc, sau đó tưới nước để phân thấm vào đất, thúc đẩy quá trình ra hoa của cây", TaskName = "Bón thúc lần 2", TaskType = "Fertilizing", StartDate = new DateTime(2025, 5, 28, 7, 30, 0), EndDate = new DateTime(2025, 5, 28, 10, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 43, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây bắt đầu xuất hiện hoa", TaskName = "Tưới nước cho cây cà chua 15", TaskType = "Watering", StartDate = new DateTime(2025, 5, 28, 7, 30, 0), EndDate = new DateTime(2025, 5, 28, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 44, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây bắt đầu xuất hiện quả non", TaskName = "Tưới nước cho cây cà chua 16", TaskType = "Watering", StartDate = new DateTime(2025, 5, 29, 7, 30, 0), EndDate = new DateTime(2025, 5, 29, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 45, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: bấm ngọn khi cây đạt chiều cao mong muốn để hạn chế cây phát triển quá mức và tập trung dinh dưỡng cho quả.", TaskName = "Tưới nước cho cây cà chua 17", TaskType = "Watering", StartDate = new DateTime(2025, 5, 30, 7, 30, 0), EndDate = new DateTime(2025, 5, 30, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 46, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: kiểm tra quả non có thể bị sâu bệnh", TaskName = "Tưới nước cho cây cà chua 18", TaskType = "Watering", StartDate = new DateTime(2025, 5, 31, 7, 30, 0), EndDate = new DateTime(2025, 5, 31, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 47, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây có thể xuất hiện sâu đục quả", TaskName = "Tưới nước cho cây cà chua 19", TaskType = "Watering", StartDate = new DateTime(2025, 6,1 , 7, 30, 0), EndDate = new DateTime(2025, 6, 1, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 48, PlanId = 8, Description = "Phun thuốc phòng ngừa sâu bệnh ăn hoa,trái non , phun thuốc vào sáng sớm", TaskName = "Phun định kỳ 3", TaskType = "Pesticide", StartDate = new DateTime(2025, 6, 2, 7, 30, 0), EndDate = new DateTime(2025, 6,2, 10, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 49, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây có thể xuất hiện chùm quả, hãy giúp cây nâng trái bằng giàn", TaskName = "Tưới nước cho cây cà chua 20", TaskType = "Watering", StartDate = new DateTime(2025, 6,3, 7, 30, 0), EndDate = new DateTime(2025, 6, 3, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 50, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: quả đạt chất lượng cao khi một chùm có từ 4 - 6 quả", TaskName = "Tưới nước cho cây cà chua 21", TaskType = "Watering", StartDate = new DateTime(2025, 6, 4, 7, 30, 0), EndDate = new DateTime(2025, 6, 4, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 51, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: tỉa những tỉa bớt quả trong mỗi chùm ", TaskName = "Tưới nước cho cây cà chua 22", TaskType = "Watering", StartDate = new DateTime(2025, 6, 5, 7, 30, 0), EndDate = new DateTime(2025, 6, 5, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 52, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: kiểm tra màu sắc của lá cây,quả", TaskName = "Tưới nước cho cây cà chua 23", TaskType = "Watering", StartDate = new DateTime(2025, 6, 6, 7, 30, 0), EndDate = new DateTime(2025, 6, 6, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 53, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây có thể xuất hiện vết bệnh màu nâu đen trên lá, thân và quả", TaskName = "Tưới nước cho cây cà chua 24", TaskType = "Watering", StartDate = new DateTime(2025, 6, 7, 7, 30, 0), EndDate = new DateTime(2025, 6, 7, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 54, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây có thể xuất hiện sâu đục quả", TaskName = "Tưới nước cho cây cà chua 25", TaskType = "Watering", StartDate = new DateTime(2025, 6, 8, 7, 30, 0), EndDate = new DateTime(2025, 6, 8, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 55, PlanId = 8, Description = "Bón phân thúc: Bón rải quanh gốc, sau đó tưới nước để phân thấm vào đất, thúc đẩy quá trình nuôi quả", TaskName = "Bón thúc lần 3", TaskType = "Fertilizing", StartDate = new DateTime(2025, 6,9, 7, 30, 0), EndDate = new DateTime(2025, 6, 9, 10, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 56, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: quả có màu xanh đậm, cứng, chưa phát triển đầy đủ", TaskName = "Tưới nước cho cây cà chua 26", TaskType = "Watering", StartDate = new DateTime(2025, 6, 10, 7, 30, 0), EndDate = new DateTime(2025, 6, 11, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 57, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: đường kính quả có thể từ 10-30mm", TaskName = "Tưới nước cho cây cà chua 27", TaskType = "Watering", StartDate = new DateTime(2025, 6, 12, 7, 30, 0), EndDate = new DateTime(2025, 6, 12, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 58, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây rất dễ xuất hiện sâu đục quả", TaskName = "Tưới nước cho cây cà chua 28", TaskType = "Watering", StartDate = new DateTime(2025, 6, 13, 7, 30, 0), EndDate = new DateTime(2025, 6, 13, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 59, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: đường kính quả có thể từ 15-40mm", TaskName = "Tưới nước cho cây cà chua 29", TaskType = "Watering", StartDate = new DateTime(2025, 6, 14, 7, 30, 0), EndDate = new DateTime(2025, 6, 13, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 60, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây rất dễ bị bệnh mốc sương", TaskName = "Tưới nước cho cây cà chua 30", TaskType = "Watering", StartDate = new DateTime(2025, 6, 15, 7, 30, 0), EndDate = new DateTime(2025, 6, 13, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 61, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây rất dễ xuất hiện sâu đục quả", TaskName = "Tưới nước cho cây cà chua 31", TaskType = "Watering", StartDate = new DateTime(2025, 6, 16, 7, 30, 0), EndDate = new DateTime(2025, 6, 16, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 62, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: đường kính quả có thể từ 30-50mm", TaskName = "Tưới nước cho cây cà chua 32", TaskType = "Watering", StartDate = new DateTime(2025, 6, 17, 7, 30, 0), EndDate = new DateTime(2025, 6, 17, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 63, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây rất dễ xuất hiện sâu đục quả", TaskName = "Tưới nước cho cây cà chua 33", TaskType = "Watering", StartDate = new DateTime(2025, 6, 18, 7, 30, 0), EndDate = new DateTime(2025, 6, 18, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 64, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: cây rất dễ xuất hiện sâu đục quả", TaskName = "Tưới nước cho cây cà chua 34", TaskType = "Watering", StartDate = new DateTime(2025, 6, 19, 7, 30, 0), EndDate = new DateTime(2025, 6, 19, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 65, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: đường kính quả có thể đạt 50 mm đến dưới 70 mm ", TaskName = "Tưới nước cho cây cà chua 35", TaskType = "Watering", StartDate = new DateTime(2025, 6, 20, 7, 30, 0), EndDate = new DateTime(2025, 6, 20, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 66, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Tránh tưới quá nhiều: Không nên tưới quá nhiều nước, đặc biệt khi quả bắt đầu chín, để tránh hiện tượng nứt quả và giảm độ ngọt ", TaskName = "Tưới nước cho cây cà chua 36", TaskType = "Watering", StartDate = new DateTime(2025, 6, 21, 7, 30, 0), EndDate = new DateTime(2025, 6, 21, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 67, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: quả có thể xuất hiện vệt màu hồng hoặc đỏ nhạt ở phần đáy quả", TaskName = "Tưới nước cho cây cà chua 37", TaskType = "Watering", StartDate = new DateTime(2025, 6, 22, 7, 30, 0), EndDate = new DateTime(2025, 6, 22, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
                new CaringTask { Id = 68, PlanId = 8, Description = "Tưới nước đều đặn vào sáng sớm, Chú ý: tránh tưới quá nhiều", TaskName = "Tưới nước cho cây cà chua 38", TaskType = "Watering", StartDate = new DateTime(2025, 6, 22, 7, 30, 0), EndDate = new DateTime(2025, 6, 22, 9, 30, 0), Status = "Pending", CreatedAt = DateTime.Now, CreatedBy = "Lê Quang C" },
            ...
            modelBuilder.Entity<CaringPesticide>().HasData(
                ...
                new CaringPesticide { Id = 11, PesticideId = 14, TaskId = 11, Unit = "Lít", Quantity = 3.0f },
                new CaringPesticide { Id = 12, PesticideId = 2, TaskId = 29, Unit = "Lít", Quantity = 3.0f },
                new CaringPesticide { Id = 13, PesticideId = 11, TaskId = 38, Unit = "Lít", Quantity = 5.8f },
                new CaringPesticide { Id = 14, PesticideId = 2, TaskId = 48, Unit = "Lít", Quantity = 3.5f }
            );
            ...
            modelBuilder.Entity<HarvestingTask>().HasData(
                ...
                new HarvestingTask { Id = 4, PlanId = 4, TaskName = "Thu hoạch dưa leo", Description = "Thu hoạch dưa leo vào đúng thời điểm chín", StartDate = DateTime.Now.AddDays(-9), EndDate = DateTime.Now.AddDays(-1), CompleteDate = DateTime.Now, HarvestedQuantity = 2000, CreatedAt = DateTime.Now.AddDays(-4), CreatedBy = "thangbinhbeo", Status = "Cancel" },
            ...
            modelBuilder.Entity<Item>().HasData(
                // (Caring Task)
                new Item { Id = 1, Name = "Bình tưới cây", Description = "Bình tưới nước dung tích 5L", Quantity = 10000, Unit = "Cái", Image = "https://product.hstatic.net/200000199113/product/7220965_7709e84c2e3f40cf8111c44225c96646_large.jpg", Status = "Active", Type = "Caring" },
                new Item { Id = 2, Name = "Kéo cắt tỉa", Description = "Kéo chuyên dụng để cắt tỉa cành", Quantity = 10000, Unit = "Cái", Image = "https://fact-depot.com/tmp/cache/images/_thumbs/720x720/media/product/30542/Keo-cat-tia-cong-vien-cay-xanh-HM044-cat-tia-co-la.png", Status = "Active", Type = "Caring" },
                new Item { Id = 3, Name = "Bón phân hữu cơ", Description = "Dụng cụ bón phân dạng viên", Quantity = 10000, Unit = "Hộp", Image = "https://vn-live-01.slatic.net/p/eab87be47ffa092ca1becbc00ff06ed2.jpg", Status = "In-stock", Type = "Caring" },
                new Item { Id = 4, Name = "Máy đo độ ẩm đất", Description = "Dụng cụ đo độ ẩm của đất", Quantity = 10000, Unit = "Cái", Image = "https://thbvn.com/cdn/images/may-do-do-am/dung-cu-do-do-am-dat-tot-1.jpg", Status = "Active", Type = "Caring" },
                new Item { Id = 13, Name = "Cái cào", Description = "Chủ yếu dùng làm tơi đất hay san phẳng bề mặt đất, với loại cào này răng của nó thường được làm thưa và dài hơn cào nhiều răng nhưng độ chắc khỏe lại rất tốt. Để san phẳng đất bạn hãy làm như sau: Hai tay của bạn nắm chắc vào cán cào, một chân bước lên trước, lưng thẳng và hơi cúi người đồng thời bạn hạ thấp trọng tâm xuống dưới, tư thế giống như đứng cuốc đất là được, tiếp theo bạn dùng lực bổ nhẹ cào xuống đất để cho đất được tơi và bằng phẳng, bạn cứ làm như thế đến khi nào đạt được độ bằng phẳng như ý thì thôi. các bạn nên chú ý khi dùng Cào đất trồng cây  thì phải cào đất từ trên xuống dưới và từ bên này qua bên kia để không giẫm lên phần đất đã cào rồi.", Quantity = 10000, Unit = "Cái", Image = "https://cayvahoa.net/wp-content/uploads/2016/11/C%C3%A0o-%C4%91%E1%BA%A5t-tr%E1%BB%93ng-c%C3%A2y-2.jpeg", Status = "Active", Type = "Caring" },
                new Item { Id = 14, Name = "Rổ đựng hạt", Description = "HƯỚNG DẪN SỬ DỤNG VÀ BẢO QUẢN SẢN PHẨM ❤️  -   Để nơi khô ráo, tránh các chất tẩy rửa  -   Sử dụng khăn ẩm để lau các vết dơ trong quá trình sử dụng, không ngâm sản phẩm vào nước  -   Phơi nắng sau khi lau bằng khăn ẩm", Quantity = 10000, Unit = "Cái", Image = "https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lzkfh6a6mr7x0d", Status = "Active", Type = "Harvesting" },
                new Item { Id = 15, Name = "Máy bơm nước", Description = "Lưu ý khi sử dụng máy bơm GP-350JAKhông sử dụng với nguồn nước không ổn định, lúc có nước, lúc không, gây nhanh mòn phớt, trục bơm gây rỉ nước buồng bơm. Không sử dụng với nguồn nước có nhiệt độ cao hơn 45⁰C hoặc chứa nhiều cặn, sỏi, vì sẽ khiến máy bơm bị kẹt và giảm tuổi thọ. Lắp đặt máy bơm GP-350JA gần nguồn nước đầu vào, hiệu quả đẩy nước sẽ được tăng cường đáng kể.", Quantity = 10000, Unit = "Máy", Image = "https://thietbipanasonic.vn/wp-content/uploads/2023/04/may-bom-nuoc-day-cao-panasonic-gp-350ja.jpg", Status = "Active", Type = "Caring" },
                new Item { Id = 16, Name = "Bộ dụng cụ làm cỏ", Description = "Như vậy để nâng cao hiệu quả trong quá trình diệt cỏ dại, cần xem xét đến các yếu tố về tình trạng thảm cỏ, các loại cây trồng xung quanh, tác hại và cả lợi ích mà cỏ dại mang đến. Sau đó bạn hoàn toàn có thể sử dụng một hoặc một số dụng cụ làm cỏ vườn, dụng cụ nhà nông và kể cả các loại dụng cụ trong sinh hoạt để diệt cỏ dại. Ngoài ra, nên lựa chọn các dụng cụ hỗ trợ làm cỏ nhanh chóng, ít tốn công sức và sử dụng lại được nhiều lần như máy cắt cỏ, bình xịt điện… để kiểm soát cỏ dại liên tục, hiệu quả và tiết kiệm nhất.", Quantity = 10000, Unit = "Bộ", Image = "https://file.hstatic.net/1000340024/file/dung-cu-lam-co-vuon-03_7ba808d11f1b43c999ee1ac2c2266ba7_grande.jpg", Status = "Active", Type = "Caring" },
                new Item { Id = 17, Name = "Bình xịt (phun) chuyên dụng DUDACO - 2 Lít", Description = "Bình tưới chuyên dụng Dudaco là sản phẩm được sản xuất từ nhựa bền, đẹp và tiện lợi. Bình tưới Dudaco có van điều chỉnh tia nước dạng phun sương hoặc dạng tia thẳng với khoảng cách phun lên đến 1,5m. Bình tưới Dudaco dùng để tưới các loại hoa như Hoa lan, Hoa hồng, Hoa cúc,.. và các loại rau trong giai đoạn cây con.", Quantity = 10000, Unit = "Cái", Image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkgsJxg7IorcEusLn9NMhlV-qTictfX_9Fwg&s", Status = "Active", Type = "Caring" },
                new Item { Id = 18, Name = "Thùng đựng nông sản Nikawa FWA-BA", Description = "Thùng đựng nông sản thường được làm từ carton để bảo quản và vận chuyển. Thùng carton giúp giữ tươi củ quả hay rau và có nhiều kích cỡ khác nhau. Để đảm bảo khả năng chịu lực, đặc biệt khi nông sản có trọng lượng lớn, thùng 5 lớp hoặc 7 lớp thường được sử dụng. Bên cạnh đó, hộp nhựa cũng là một lựa chọn khác để bảo vệ nông sản khỏi các tác động bên ngoài.", Quantity = 10000, Unit = "Cái", Image = "https://www.ketnoitieudung.vn/data/bt7/thumb_350/gio-nhua-dung-hang-nikawa-fwa-ba-1689146278.jpg", Status = "Active", Type = "Harvesting" },
                new Item { Id = 19, Name = "Bộ phun sương mini", Description = "Bộ phun sương mini có nhiều loại, bao gồm máy bơm 12V áp lực cao với lưu lượng 8L/phút, thích hợp tưới cây hoặc rửa xe. Máy phun sương Daehan có cục nguồn rời, dễ sử dụng. Một bộ khác có kèm điều chỉnh lượng nước. Giá cả và mẫu mã đa dạng, từ vài chục nghìn đến vài trăm nghìn đồng.", Quantity = 10000, Unit = "Cái", Image = "https://vn-live-01.slatic.net/p/0b9e8dea595558b5ab9dda1c73287527.jpg", Status = "Active", Type = "Caring" },
                new Item { Id = 20, Name = "Bộ cảm biến đất", Description = "Cảm biến có chức năng phát hiện độ ẩm trong đất hoặc phát hiện nước thường được sử dụng trong các mô hình tưới nước tự động, ngăn chặn tình trạng thiếu nước cho vật thể. Mạch được thiết kế với bề mặt cảm biến bằng kim loại và có độ bền cao, sử dụng đơn giản với ngõ ra cả tín hiệu analog và tín hiệu số tương thích với Arduino và các bộ vi điều khiển.", Quantity = 10000, Unit = "Bộ", Image = "https://nshopvn.com/wp-content/uploads/2019/03/cam-bien-do-am-dat-m9bi-3.jpg", Status = "Active", Type = "Caring" },
                new Item { Id = 21, Name = "Đèn LED nông nghiệp", Description = "Đèn LED cho cây là một giải pháp chiếu sáng hiệu quả cho việc trồng trọt trong nhà và ngoài trời. Đèn LED giúp kích thích sự phát triển của cây bằng cách cung cấp quang phổ ánh sáng phù hợp cho quá trình quang hợp. Các sản phẩm đèn LED trồng cây phổ biến bao gồm đèn tuýp, đèn panel, và đèn có thể điều chỉnh cường độ ánh sáng. Một số thương hiệu như Rạng Đông cung cấp các loại đèn LED nông nghiệp tiết kiệm điện và dễ dàng lắp đặt. Giá cả của đèn LED trồng cây cũng rất đa dạng, tùy thuộc vào công suất và tính năng.", Quantity = 10000, Unit = "Cái", Image = "https://heesun.com.vn/public/media/den_led-nong-nghiep-min.jpg", Status = "Active", Type = "Caring" },
                new Item { Id = 22, Name = "Bao rơm giữ ẩm", Description = "Công dụng trong làm vườn- Được dùng để làm ủ phân hữu cơ rất tốt cho cây. - Nguyên liệu quan trọng để nuôi trồng nấm rơm. - Bảo vệ những quả dâu tây chín khỏi bụi bẩn và dập úng. Và cũng được sử dụng để phủ lên cây trong mùa đông để ngăn cái lạnh. - Rơm cũng làm cho một lớp phủ tuyệt vời giữ ẩm cho cây vào mùa khô, chống văng hạt và đất ra khỏi chậu vào mùa mưa. - Lót 1 lớp rơm xung quanh cây con mới cấy giúp chống dập lá rau non. - Chống lấm bẩn bùn đất lên tường.", Quantity = 10000, Unit = "Bao", Image = "https://vuonsaigon.vn/wp-content/uploads/2020/05/rom-cuon-vuon-sai-gon.png", Status = "Active", Type = "Caring" },

                // (Harvesting Task)
                new Item { Id = 5, Name = "Dao thu hoạch", Description = "Dao chuyên dụng để cắt trái cây", Quantity = 10000, Unit = "Cái", Image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMlW2sl4uFDnr7wiHZo420jhTUDtPZmPQkqw&s", Status = "In-stock", Type = "Harvesting" },
                new Item { Id = 6, Name = "Giỏ đựng nông sản", Description = "Giỏ chứa nông sản sau thu hoạch", Quantity = 10000, Unit = "Giỏ", Image = "https://ecohub.vn/wp-content/uploads/2021/08/thung-go-luu-tru-nong-san-do-dung-1.jpg", Status = "In-stock", Type = "Harvesting" },
                new Item { Id = 7, Name = "Máy cắt lúa", Description = "Máy gặt đập liên hợp mini", Quantity = 10000, Unit = "Máy", Image = "https://mayxaydungmlk.vn/wp-content/uploads/2022/07/may-gat-DC60.jpg", Status = "In-stock", Type = "Harvesting" },
                // (Packaging Task)
                new Item { Id = 8, Name = "Máy đóng gói tự động", Unit = "Máy", Description = "Máy đóng gói tốc độ cao cho nông sản.", Image = "https://dienmayviteko.com/pic/Product/VPM-BZJ600-4_1029_HasThumb.webp", Quantity = 10000, Status = "Active", Type = "Packaging" },
                new Item { Id = 9, Name = "Máy hút chân không", Unit = "Máy", Description = "Thiết bị bảo quản sản phẩm bằng cách hút chân không.", Image = "https://dbk.vn/uploads/ckfinder/images/may-hut-chan-khong/may-hut-chan-khong-cong-nghiep-Magic-Air-MZ600.jpg", Quantity = 10000, Status = "Active", Type = "Packaging" },
                new Item { Id = 10, Name = "Cân điện tử đóng gói", Unit = "Máy", Description = "Cân chính xác dùng trong quy trình đóng gói.", Image = "https://cokhitanminh.com/may-dong-goi/wp-content/uploads/2021/11/may-dong-goi-can-dien-tu-3-bien-tmdg-2f14-ckmdg-1.jpg", Quantity = 10000, Status = "Active", Type = "Packaging" },
                new Item { Id = 11, Name = "Máy đóng gói túi", Unit = "Máy", Description = "Máy đóng gói túi ni lông hoặc túi giấy cho sản phẩm nông nghiệp.", Image = "https://cnva.vn/wp-content/uploads/2024/02/may-dong-goi-tui-roi-tui-zip.jpg", Quantity = 10000, Status = "In-stock", Type = "Packaging" },
                new Item { Id = 12, Name = "Dây chuyền đóng gói", Unit = "Dây", Description = "Dây chuyền đóng gói tự động hỗ trợ quy trình sản xuất.", Image = "https://mayduoctiendat.com/upload/filemanager/files/day-chuyen-dong-goi-bot-hop-thiec-tu-dong.jpg", Quantity = 10000, Status = "Out-stock", Type = "Packaging" }
            );
            ...
            modelBuilder.Entity<Order>().HasData(
                ...
                new Order { Id = 6, RetailerId = 1, PlantId = 2, PackagingTypeId = 5, DepositPrice = 7500000.0f, TotalPrice = 25000000.0f, PreOrderQuantity = 220f, Status = "Reject", Phone = "0923456789", EstimatedPickupDate = DateTime.Now.AddMonths(5), CreatedAt = DateTime.Now.AddDays(-5) },
                new Order { Id = 7, RetailerId = 3, PlantId = 4, PackagingTypeId = 5, DepositPrice = 7500000.0f, TotalPrice = 25000000.0f, PreOrderQuantity = 120f, Status = "PendingConfirmation", Phone = "0945678901", EstimatedPickupDate = DateTime.Now.AddDays(12), CreatedAt = DateTime.Now.AddDays(-2) },
                new Order { Id = 8, RetailerId = 1, PlantId = 3, PackagingTypeId = 5, DepositPrice = 7500000.0f, TotalPrice = 25000000.0f, PreOrderQuantity = 320f, Status = "Forfeit", Phone = "0923456789", EstimatedPickupDate = DateTime.Now.AddDays(11), CreatedAt = DateTime.Now.AddDays(-3) },
                new Order { Id = 9, RetailerId = 2, PlantId = 1, PackagingTypeId = 2, DepositPrice = 4500000.0f, TotalPrice = 15000000.0f, PreOrderQuantity = 220f, Status = "Deposit", Phone = "0956789012", EstimatedPickupDate = DateTime.Now.AddMonths(4), CreatedAt = DateTime.Now.AddDays(-2) },
                new Order { Id = 10, RetailerId = 3, PlantId = 4, PackagingTypeId = 1, DepositPrice = 8600000.0f, TotalPrice = 28600000.0f, PreOrderQuantity = 300f, Status = "Paid", Phone = "0967890123", EstimatedPickupDate = DateTime.Now.AddDays(8), CreatedAt = DateTime.Now.AddDays(-7) },
                new Order { Id = 11, RetailerId = 1, PlantId = 3, PackagingTypeId = 2, DepositPrice = 360000f, TotalPrice = 1200000f, PreOrderQuantity = 60f, Status = "Deposit", Phone = "0838097512", EstimatedPickupDate = DateTime.Now, CreatedAt = DateTime.Now.AddMonths(-2)}
            );
