    ...
    public static class FakeDataSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Plan>().HasData(
                new Plan { Id = 1, PlantId = 1, YieldId = 1, ExpertId = 1, PlanName = "Trồng cà chua vụ đông", Description = "Kế hoạch trồng cà chua vào mùa đông", StartDate = new DateTime(2024, 1, 10), EndDate = new DateTime(2024, 4, 15), Status = "Ongoing", EstimatedProduct = 500, EstimatedUnit = "kg", CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = true },
                new Plan { Id = 2, PlantId = 2, YieldId = 2, ExpertId = 2, PlanName = "Trồng dưa lưới", Description = "Kế hoạch trồng dưa lưới trong nhà kính", StartDate = new DateTime(2024, 2, 1), EndDate = new DateTime(2024, 6, 1), Status = "Pending", EstimatedProduct = 300, EstimatedUnit = "kg", CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = false },
                new Plan { Id = 3, PlantId = 3, YieldId = 3, ExpertId = 3, PlanName = "Trồng bắp cải", Description = "Kế hoạch trồng bắp cải sạch", StartDate = new DateTime(2024, 3, 15), EndDate = new DateTime(2024, 6, 30), Status = "Ongoing", EstimatedProduct = 400, EstimatedUnit = "kg", CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = true },
                new Plan { Id = 4, PlantId = 4, YieldId = 4, ExpertId = 1, PlanName = "Trồng rau muống", Description = "Kế hoạch trồng rau muống ngắn ngày", StartDate = new DateTime(2024, 4, 5), EndDate = new DateTime(2024, 5, 5), Status = "Completed", EstimatedProduct = 200, EstimatedUnit = "kg", CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = true },
                new Plan { Id = 5, PlantId = 5, YieldId = 5, ExpertId = 2, PlanName = "Trồng cà rốt", Description = "Kế hoạch trồng cà rốt hữu cơ", StartDate = new DateTime(2024, 5, 1), EndDate = new DateTime(2024, 9, 1), Status = "Pending", EstimatedProduct = 350, EstimatedUnit = "kg", CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = false },
                new Plan { Id = 6, PlantId = 6, YieldId = 6, ExpertId = 3, PlanName = "Trồng hành lá", Description = "Kế hoạch trồng hành lá sạch", StartDate = new DateTime(2024, 6, 10), EndDate = new DateTime(2024, 9, 30), Status = "Ongoing", EstimatedProduct = 250, EstimatedUnit = "kg", CreatedAt = DateTime.Now, CreatedBy = "Admin", IsApproved = true }
            );
            ...
            modelBuilder.Entity<PackagingTask>().HasData(
                new PackagingTask { Id = 1, FarmerId = 1, PlanId = 1, TaskName = "Đóng gói gạo", PackedUnit = "kg", PackedQuantity = 1000, Description = "Đóng gói gạo vào túi 5kg", StartDate = DateTime.Now.AddDays(-5), EndDate = DateTime.Now.AddDays(2), Status = "InProgress", CreatedAt = DateTime.Now.AddDays(-6), UpdatedAt = DateTime.Now, Priority = 1 },
                new PackagingTask { Id = 2, FarmerId = 2, PlanId = 2, TaskName = "Đóng gói cà phê", PackedUnit = "kg", PackedQuantity = 500, Description = "Đóng gói cà phê bột vào túi 1kg", StartDate = DateTime.Now.AddDays(-3), EndDate = DateTime.Now.AddDays(1), Status = "InProgress", CreatedAt = DateTime.Now.AddDays(-4), UpdatedAt = DateTime.Now, Priority = 2 },
                new PackagingTask { Id = 3, FarmerId = 3, PlanId = 3, TaskName = "Đóng gói trà xanh", PackedUnit = "g", PackedQuantity = 20000, Description = "Đóng gói trà xanh vào hộp 100g", StartDate = DateTime.Now.AddDays(-2), EndDate = DateTime.Now.AddDays(3), Status = "Pending", CreatedAt = DateTime.Now.AddDays(-3), UpdatedAt = DateTime.Now, Priority = 3 },
                new PackagingTask { Id = 4, FarmerId = 4, PlanId = 4, TaskName = "Đóng gói hạt điều", PackedUnit = "kg", PackedQuantity = 300, Description = "Đóng gói hạt điều vào túi 500g", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(4), Status = "Pending", CreatedAt = DateTime.Now.AddDays(-1), UpdatedAt = DateTime.Now, Priority = 2 },
                new PackagingTask { Id = 5, FarmerId = 5, PlanId = 5, TaskName = "Đóng gói xoài sấy", PackedUnit = "g", PackedQuantity = 10000, Description = "Đóng gói xoài sấy vào túi 250g", StartDate = DateTime.Now.AddDays(1), EndDate = DateTime.Now.AddDays(5), Status = "Planned", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, Priority = 1 }
            );
            ...
            modelBuilder.Entity<Item>().HasData(
                // (Caring Task)
                new Item { Id = 1, Name = "Bình tưới cây", Description = "Bình tưới nước dung tích 5L", Image = "https://product.hstatic.net/200000199113/product/7220965_7709e84c2e3f40cf8111c44225c96646_large.jpg", Status = "Available", Type = "Caring" },
                new Item { Id = 2, Name = "Kéo cắt tỉa", Description = "Kéo chuyên dụng để cắt tỉa cành", Image = "https://fact-depot.com/tmp/cache/images/_thumbs/720x720/media/product/30542/Keo-cat-tia-cong-vien-cay-xanh-HM044-cat-tia-co-la.png", Status = "Available", Type = "Caring" },
                new Item { Id = 3, Name = "Bón phân hữu cơ", Description = "Dụng cụ bón phân dạng viên", Image = "https://vn-live-01.slatic.net/p/eab87be47ffa092ca1becbc00ff06ed2.jpg", Status = "Available", Type = "Caring" },
                new Item { Id = 4, Name = "Máy đo độ ẩm đất", Description = "Dụng cụ đo độ ẩm của đất", Image = "https://thbvn.com/cdn/images/may-do-do-am/dung-cu-do-do-am-dat-tot-1.jpg", Status = "Available", Type = "Caring" },
                // (Harvesting Task)
                new Item { Id = 5, Name = "Dao thu hoạch", Description = "Dao chuyên dụng để cắt trái cây", Image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMlW2sl4uFDnr7wiHZo420jhTUDtPZmPQkqw&s", Status = "Available", Type = "Harvesting" },
                new Item { Id = 6, Name = "Giỏ đựng nông sản", Description = "Giỏ chứa nông sản sau thu hoạch", Image = "https://ecohub.vn/wp-content/uploads/2021/08/thung-go-luu-tru-nong-san-do-dung-1.jpg", Status = "Available", Type = "Harvesting" },
                new Item { Id = 7, Name = "Máy cắt lúa", Description = "Máy gặt đập liên hợp mini", Image = "https://mayxaydungmlk.vn/wp-content/uploads/2022/07/may-gat-DC60.jpg", Status = "In Use", Type = "Harvesting" },
                // (Packaging Task)
                new Item { Id = 8, Name = "Máy đóng gói tự động", Description = "Máy đóng gói tốc độ cao cho nông sản.", Image = "https://dienmayviteko.com/pic/Product/VPM-BZJ600-4_1029_HasThumb.webp", Quantity = 5, Status = "Available", Type = "Packaging" },
                new Item { Id = 9, Name = "Máy hút chân không", Description = "Thiết bị bảo quản sản phẩm bằng cách hút chân không.", Image = "https://dbk.vn/uploads/ckfinder/images/may-hut-chan-khong/may-hut-chan-khong-cong-nghiep-Magic-Air-MZ600.jpg", Quantity = 8, Status = "Available", Type = "Packaging" },
                new Item { Id = 10, Name = "Cân điện tử đóng gói", Description = "Cân chính xác dùng trong quy trình đóng gói.", Image = "https://cokhitanminh.com/may-dong-goi/wp-content/uploads/2021/11/may-dong-goi-can-dien-tu-3-bien-tmdg-2f14-ckmdg-1.jpg", Quantity = 10, Status = "Available", Type = "Packaging" },
                new Item { Id = 11, Name = "Máy đóng gói túi", Description = "Máy đóng gói túi ni lông hoặc túi giấy cho sản phẩm nông nghiệp.", Image = "https://cnva.vn/wp-content/uploads/2024/02/may-dong-goi-tui-roi-tui-zip.jpg", Quantity = 7, Status = "Available", Type = "Packaging" },
                new Item { Id = 12, Name = "Dây chuyền đóng gói", Description = "Dây chuyền đóng gói tự động hỗ trợ quy trình sản xuất.", Image = "https://mayduoctiendat.com/upload/filemanager/files/day-chuyen-dong-goi-bot-hop-thiec-tu-dong.jpg", Quantity = 2, Status = "Available", Type = "Packaging" }
            );
