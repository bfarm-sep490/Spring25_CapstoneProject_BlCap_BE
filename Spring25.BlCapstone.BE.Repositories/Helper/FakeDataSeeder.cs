    ...
    public static class FakeDataSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PackagingTask>().HasData(
                new PackagingTask { Id = 1, PlanId = 1, TaskName = "Đóng gói gạo", ResultContent = "Đã đóng gói theo túi 5kg, thu được 1000 túi", PackedQuantity = 1000, Description = "Đóng gói gạo vào túi 5kg", StartDate = DateTime.Now.AddDays(-5), EndDate = DateTime.Now.AddDays(2), CompleteDate = DateTime.Now.AddDays(3), Status = "Complete", CreatedAt = DateTime.Now.AddDays(-6), CreatedBy = "thangbinhbeo", UpdatedAt = DateTime.Now },
                new PackagingTask { Id = 2, PlanId = 2, TaskName = "Đóng gói cà phê", ResultContent = "Đã đóng gói được 500 túi", PackedQuantity = 500, Description = "Đóng gói cà phê bột vào túi 1kg", StartDate = DateTime.Now.AddDays(-3), EndDate = DateTime.Now.AddDays(1), CompleteDate = DateTime.Now.AddDays(3), Status = "Complete", CreatedAt = DateTime.Now.AddDays(-4), CreatedBy = "thangbinhbeo", UpdatedAt = DateTime.Now },
                new PackagingTask { Id = 3, PlanId = 3, TaskName = "Đóng gói trà xanh", ResultContent = "Đã đóng gói thành công 20000 gói", PackedQuantity = 20000, Description = "Đóng gói trà xanh vào hộp 100g", StartDate = DateTime.Now.AddDays(-2), EndDate = DateTime.Now.AddDays(3), CompleteDate = DateTime.Now.AddDays(3), Status = "Complete", CreatedAt = DateTime.Now.AddDays(-3), CreatedBy = "thangbinhbeo", UpdatedAt = DateTime.Now },
                new PackagingTask { Id = 4, PlanId = 4, TaskName = "Đóng gói hạt điều", ResultContent = "Đã đóng gói thành công", PackedQuantity = 300, Description = "Đóng gói hạt điều vào túi 500g", StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(4), CompleteDate = DateTime.Now.AddDays(3), Status = "Complete", CreatedAt = DateTime.Now.AddDays(-1), CreatedBy = "thangbinhbeo", UpdatedAt = DateTime.Now },
                new PackagingTask { Id = 5, PlanId = 5, TaskName = "Đóng gói xoài sấy", ResultContent = "Đã đóng gói 10000 gói", PackedQuantity = 10000, Description = "Đóng gói xoài sấy vào túi 250g", StartDate = DateTime.Now.AddDays(1), EndDate = DateTime.Now.AddDays(5), CompleteDate = DateTime.Now.AddDays(3), Status = "Complete", CreatedAt = DateTime.Now, CreatedBy = "thangbinhbeo", UpdatedAt = DateTime.Now }
            );
            ...
            modelBuilder.Entity<InspectingResult>().HasData(
                new InspectingResult { Id = 1, FormId = 1, Arsen = 0.01f, Plumbum = 0.02f, Cadmi = 0.005f, Hydrargyrum = 0.001f, Salmonella = 0, Coliforms = 10, Ecoli = 1, Glyphosate_Glufosinate = 0.02f, SulfurDioxide = 5, MethylBromide = 0.1f, HydrogenPhosphide = 0.05f, Dithiocarbamate = 0.02f, Nitrat = 50, NaNO3_KNO3 = 10, Chlorate = 0.1f, Perchlorate = 0.02f, EvaluatedResult = "Pass" },
                new InspectingResult { Id = 2, FormId = 2, Arsen = 0.02f, Plumbum = 0.03f, Cadmi = 0.007f, Hydrargyrum = 0.002f, Salmonella = 1, Coliforms = 20, Ecoli = 3, Glyphosate_Glufosinate = 0.03f, SulfurDioxide = 10, MethylBromide = 0.2f, HydrogenPhosphide = 0.06f, Dithiocarbamate = 0.03f, Nitrat = 60, NaNO3_KNO3 = 15, Chlorate = 0.2f, Perchlorate = 0.03f, EvaluatedResult = "Fail" },
                new InspectingResult { Id = 3, FormId = 3, Arsen = 0.005f, Plumbum = 0.015f, Cadmi = 0.004f, Hydrargyrum = 0.0005f, Salmonella = 0, Coliforms = 5, Ecoli = 0, Glyphosate_Glufosinate = 0.015f, SulfurDioxide = 3, MethylBromide = 0.05f, HydrogenPhosphide = 0.03f, Dithiocarbamate = 0.015f, Nitrat = 40, NaNO3_KNO3 = 8, Chlorate = 0.08f, Perchlorate = 0.015f, EvaluatedResult = "Pass" },
                new InspectingResult { Id = 4, FormId = 4, Arsen = 0.03f, Plumbum = 0.04f, Cadmi = 0.01f, Hydrargyrum = 0.003f, Salmonella = 2, Coliforms = 25, Ecoli = 5, Glyphosate_Glufosinate = 0.04f, SulfurDioxide = 15, MethylBromide = 0.3f, HydrogenPhosphide = 0.08f, Dithiocarbamate = 0.04f, Nitrat = 70, NaNO3_KNO3 = 20, Chlorate = 0.3f, Perchlorate = 0.04f, EvaluatedResult = "Fail" },
                new InspectingResult { Id = 5, FormId = 5, Arsen = 0.007f, Plumbum = 0.017f, Cadmi = 0.006f, Hydrargyrum = 0.0012f, Salmonella = 0, Coliforms = 8, Ecoli = 1, Glyphosate_Glufosinate = 0.018f, SulfurDioxide = 4, MethylBromide = 0.07f, HydrogenPhosphide = 0.04f, Dithiocarbamate = 0.018f, Nitrat = 45, NaNO3_KNO3 = 9, Chlorate = 0.09f, Perchlorate = 0.018f, EvaluatedResult = "Pass" },
                new InspectingResult { Id = 6, FormId = 6, Arsen = 0.011f, Plumbum = 0.021f, Cadmi = 0.006f, Hydrargyrum = 0.0011f, Salmonella = 0, Coliforms = 9, Ecoli = 1, Glyphosate_Glufosinate = 0.022f, SulfurDioxide = 6, MethylBromide = 0.12f, HydrogenPhosphide = 0.055f, Dithiocarbamate = 0.025f, Nitrat = 55, NaNO3_KNO3 = 12, Chlorate = 0.11f, Perchlorate = 0.022f, EvaluatedResult = "Pass" },
                new InspectingResult { Id = 7, FormId = 1, Arsen = 0.025f, Plumbum = 0.035f, Cadmi = 0.009f, Hydrargyrum = 0.0022f, Salmonella = 1, Coliforms = 18, Ecoli = 4, Glyphosate_Glufosinate = 0.035f, SulfurDioxide = 12, MethylBromide = 0.25f, HydrogenPhosphide = 0.07f, Dithiocarbamate = 0.035f, Nitrat = 65, NaNO3_KNO3 = 18, Chlorate = 0.22f, Perchlorate = 0.035f, EvaluatedResult = "Fail" },
                new InspectingResult { Id = 8, FormId = 2, Arsen = 0.008f, Plumbum = 0.018f, Cadmi = 0.005f, Hydrargyrum = 0.0009f, Salmonella = 0, Coliforms = 7, Ecoli = 1, Glyphosate_Glufosinate = 0.017f, SulfurDioxide = 4, MethylBromide = 0.06f, HydrogenPhosphide = 0.035f, Dithiocarbamate = 0.017f, Nitrat = 42, NaNO3_KNO3 = 10, Chlorate = 0.085f, Perchlorate = 0.017f, EvaluatedResult = "Pass" },
                new InspectingResult { Id = 9, FormId = 3, Arsen = 0.028f, Plumbum = 0.038f, Cadmi = 0.012f, Hydrargyrum = 0.0028f, Salmonella = 2, Coliforms = 30, Ecoli = 6, Glyphosate_Glufosinate = 0.045f, SulfurDioxide = 18, MethylBromide = 0.35f, HydrogenPhosphide = 0.09f, Dithiocarbamate = 0.045f, Nitrat = 75, NaNO3_KNO3 = 25, Chlorate = 0.35f, Perchlorate = 0.045f, EvaluatedResult = "Fail" },
                new InspectingResult { Id = 10, FormId = 4, Arsen = 0.006f, Plumbum = 0.014f, Cadmi = 0.003f, Hydrargyrum = 0.0004f, Salmonella = 0, Coliforms = 4, Ecoli = 0, Glyphosate_Glufosinate = 0.013f, SulfurDioxide = 2, MethylBromide = 0.04f, HydrogenPhosphide = 0.025f, Dithiocarbamate = 0.013f, Nitrat = 35, NaNO3_KNO3 = 7, Chlorate = 0.07f, Perchlorate = 0.013f, EvaluatedResult = "Pass" }
            );
