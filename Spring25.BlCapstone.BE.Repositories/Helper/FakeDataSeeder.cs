    ...
    public static class FakeDataSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HarvestingTask>().HasData(
                new HarvestingTask { Id = 1, PlanId = 1, FarmerId = 1, TaskName = "Thu hoạch rau cải", Description = "Thu hoạch rau cải trước khi trời quá nắng", StartDate = DateTime.Now.AddDays(-5), EndDate = DateTime.Now.AddDays(-3), CompleteDate = DateTime.Now, HarvestedQuantity = 50, HarvestedUnit = "kg", IsAvailable = true, Priority = 1, CreatedAt = DateTime.Now.AddDays(-5), Status = "Cancel" },
                new HarvestingTask { Id = 2, PlanId = 2, FarmerId = 2, TaskName = "Thu hoạch cà chua", Description = "Thu hoạch cà chua chín đỏ", StartDate = DateTime.Now.AddDays(-1).AddDays(-6), EndDate = DateTime.Now.AddDays(-4), CompleteDate = DateTime.Now.AddDays(-1), HarvestedQuantity = 30, HarvestedUnit = "kg", IsAvailable = true, Priority = 2, CreatedAt = DateTime.Now.AddDays(-1).AddDays(-6), Status = "Pending" },
                new HarvestingTask { Id = 3, PlanId = 3, FarmerId = 3, TaskName = "Thu hoạch bắp cải", Description = "Thu hoạch bắp cải vào sáng sớm để giữ độ tươi", StartDate = DateTime.Now.AddDays(-10).AddDays(-3), EndDate = DateTime.Now.AddDays(-2), CompleteDate = DateTime.Now.AddDays(-2), HarvestedQuantity = 40, HarvestedUnit = "kg", IsAvailable = true, Priority = 3, CreatedAt = DateTime.Now.AddDays(-2).AddDays(-7), Status = "Cancel" },
